					...
					<div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
						<div className="bg-white rounded-3xl p-8 shadow-sm border border-[#482977]/10">
							...
							<p className="text-[#482977]/80 leading-relaxed mb-4">
								Every eligible child (ages 5-18) receives an EC$1,000
								contribution from the Government of St. Kitts and Nevis:
							</p>
						...
						<div className="bg-white rounded-3xl p-8 shadow-sm border border-[#482977]/10">
							...
							<p className="text-[#482977]/80 leading-relaxed mb-4">
								Register online at <strong>aspire.gov.kn</strong>, or in person
								at The Cable Office on Cayon Street in Basseterre — walk-in
								support is available Monday to Friday, 9:00 AM to 3:00 PM.
							</p>
							<p className="text-sm font-semibold text-[#1A103C]">
								What you'll need:
							</p>
					...
					<div className="bg-gradient-to-br from-[#482977] to-[#1A103C] rounded-3xl p-8 text-white flex flex-col md:flex-row items-center justify-between shadow-lg">
						<div className="mb-6 md:mb-0 md:mr-8">
							...
							<p className="text-white/80">
								Help them build wealth and learn financial literacy early.
							</p>
						</div>
						<a
							...
							className="bg-[#fed141] text-[#1A103C] px-8 py-3 rounded-full font-bold hover:bg-white transition-colors whitespace-nowrap shadow-md"
						>
							Register Now
						</a>
					</div>
