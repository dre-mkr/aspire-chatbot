		...
		<div className="relative flex flex-col min-h-screen bg-white text-[#1A103C]">
			...
			<main className="flex-1 w-full max-w-4xl mx-auto px-6 py-12">
				...
				<div className="bg-white rounded-3xl p-8 md:p-12 shadow-sm border border-[#482977]/10 mb-12">
					<h2 className="text-2xl font-bold mb-6 text-[#1A103C]">Our Mission</h2>
					<p className="text-[#482977]/80 leading-relaxed text-lg mb-8">
						The ASPIRE Programme provides a foundational grant of EC$1,000 for every eligible youth in St. Kitts and Nevis, split evenly between a dedicated savings account and local investments. This landmark government initiative is designed to foster financial literacy, robust saving habits, and responsible wealth-building practices among our nation's youth.
					</p>
					...
					<div className="grid grid-cols-1 md:grid-cols-3 gap-6">
						<div className="bg-[#F5F2FA] p-6 rounded-2xl">
							...
							<p className="text-sm text-[#482977]/80">An initial EC$500 held in a savings account at the St. Kitts-Nevis-Anguilla National Bank for every eligible child.</p>
						</div>
						<div className="bg-[#F5F2FA] p-6 rounded-2xl">
							<i className="ph-duotone ph-chart-line-up text-3xl text-[#fed141] mb-4"></i>
							<h4 className="font-bold text-[#1A103C] mb-2">Local Investment</h4>
							<p className="text-sm text-[#482977]/80">A further EC$500 invested in shares of local government-owned entities.</p>
						</div>
						<div className="bg-[#F5F2FA] p-6 rounded-2xl">
							<i className="ph-duotone ph-student text-3xl text-[#c22f99] mb-4"></i>
							<h4 className="font-bold text-[#1A103C] mb-2">Education First</h4>
							<p className="text-sm text-[#482977]/80">Teaching youth aged 5-18 the fundamentals of budgeting and wealth building.</p>
						</div>
					</div>
				</div>
				
				<div className="text-center">
					<p className="text-sm font-semibold text-[#482977]/60 uppercase tracking-wider mb-4">Information sourced from</p>
					<a href="https://aspire.gov.kn/" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 text-[#c22f99] hover:text-[#482977] font-bold text-lg transition-colors">
