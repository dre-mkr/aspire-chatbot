				...
				<main className="flex-1 w-full max-w-4xl mx-auto px-6 py-12">
					...
					<div className="bg-white rounded-3xl p-8 shadow-sm border border-[#482977]/10 mb-8">
						<div className="flex flex-col md:flex-row gap-8 items-center">
							<div className="flex-1">
								...
								<h3 className="text-2xl font-bold mb-4 text-[#1A103C]">
									The ASPIRE AI Financial Curriculum
								</h3>
								<p className="text-[#482977]/80 leading-relaxed mb-4">
									Educators are at the heart of ASPIRE&rsquo;s financial
									literacy programme. Developed by the ASPIRE AI team in
									collaboration with the Eastern Caribbean Central Bank, the
									curriculum introduces students to the ideas that will shape
									their financial futures &mdash; and gives every learner a
									guide who meets them at their own age.
								</p>
								<div className="flex flex-wrap gap-2 mt-4">
									<span className="bg-[#482977]/5 text-[#482977] px-3 py-1 rounded-full text-sm font-semibold">
										Budgeting
									</span>
									<span className="bg-[#482977]/5 text-[#482977] px-3 py-1 rounded-full text-sm font-semibold">
										Saving
					...
					<div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
						<div className="bg-white rounded-3xl p-8 shadow-sm border border-[#482977]/10">
							<h3 className="text-xl font-bold mb-3 text-[#1A103C]">
								Educator Training
							</h3>
							<p className="text-[#482977]/80 leading-relaxed">
								The ASPIRE Programme hosts specialized Educator Training
								Sessions to equip teachers with the necessary knowledge and
								tools to teach financial literacy confidently in the classroom.
							</p>
						</div>
						...
						<div className="bg-white rounded-3xl p-8 shadow-sm border border-[#482977]/10">
							...
							<p className="text-[#482977]/80 leading-relaxed">
								Our AI-powered assistant and gamified learning paths help
								reinforce classroom lessons, allowing students to play, explore,
								and earn rewards while mastering the EC Dollar.
							</p>
						</div>
					</div>
				</main>
